...
namespace WebEstudo.DTO.Roles
{
    ...
    {
        public static string[] Login(this IUsuarioDTO usuarioDto, IConfiguration _configuration, string login, string senha, bool gerarToken = false)
        {
        ...
        public static string GerarToken(this IUsuarioDTO usuarioDto, IConfiguration _configuration, string idUsuarioToken)
        {
        ...
        public static bool ValidatarToken(this IUsuarioDTO usuarioDTO, IConfiguration _configuration, string token)
        {
